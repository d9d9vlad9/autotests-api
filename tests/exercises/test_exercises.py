...
from clients.exercises.exercises_schema import CreateExerciseRequestSchema, CreateExerciseResponseSchema, \
    UpdateExerciseRequestSchema, UpdateExerciseResponseSchema, GetExercisesQuerySchema, GetExercisesResponseSchema
...
class TestExercises:
    ...
    @allure.tag(AllureTag.UPDATE_ENTITIES)
    ...
    def test_get_exercises(
        ...
        """
        Проверяет получение списка упражнений.
        """
